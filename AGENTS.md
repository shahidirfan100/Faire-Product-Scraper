...
```json
{
    "actorSpecification": 1,
    "fields": {
        "pictureUrl": { "title": "Image URL", "type": "string", "description": "URL of the image" },
        "linkUrl": { "title": "Link URL", "type": "string", "description": "URL of the link" },
        "textField": { "title": "Text", "type": "string", "description": "Text content" },
        "booleanField": { "title": "Boolean", "type": "boolean", "description": "True/False value" },
        "arrayField": { "title": "Array", "type": "array", "description": "List of items" },
        "objectField": { "title": "Object", "type": "object", "description": "Nested object" },
        "dateField": { "title": "Date", "type": "string", "description": "Date value" },
        "numericField": { "title": "Number", "type": "integer", "description": "Numeric value" }
    },
    "views": {
        "overview": {
            "title": "Overview",
